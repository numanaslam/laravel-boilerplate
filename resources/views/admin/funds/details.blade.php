                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <span class="fw-bold fs-6 text-gray-800">{{ $fund->payment_method }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-lg-4 fw-semibold text-muted">Amount</label>
                                        <div class="col-lg-8">
                                            <span class="fw-bold fs-6 text-gray-800">{{ $fund->amount }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-lg-4 fw-semibold text-muted">Transaction Date</label>
                                        <div class="col-lg-8">
                                            <span class="fw-bold fs-6 text-gray-800">{{ $fund->transaction_date }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-lg-4 fw-semibold text-muted">Status</label>
                                        <div class="col-lg-8">
                                            <span class="fw-bold fs-6 text-gray-800">{{ $fund->status }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-lg-4 fw-semibold text-muted">Payment Method</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <span class="fw-bold fs-6 text-gray-800"><a href="{{url('funds')}}/{{ $fund->image }}">{{ $fund->image }}</span>
                                        </div>
                                    </div>
