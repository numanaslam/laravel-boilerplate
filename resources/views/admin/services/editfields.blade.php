                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <label
                                                            class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <input class="form-check-input" type="checkbox"
                                                            @php if($roles->hasPermissionTo('edit bookingstatus')) echo "checked" @endphp
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                    @php if($roles->hasPermissionTo('edit notifications')) echo "checked" @endphp
                                                    value="edit notifications" name="permissions[]" />
                                                <span class="form-check-label">Edit</span>
                                            </label>
                                            <!--end::Checkbox-->
                                            <!--begin::Checkbox-->
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('view cashpayment')) echo "checked" @endphp
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('add cashpayment')) echo "checked" @endphp
                                            ...
                                            <label class="form-check form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('edit cashpayment')) echo "checked" @endphp
                                            ...
                                            <label class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('delete cashpayment')) echo "checked" @endphp
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('view cardrequests')) echo "checked" @endphp
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('add cardrequests')) echo "checked" @endphp
                                            ...
                                            <label class="form-check form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('edit cardrequests')) echo "checked" @endphp
                                            ...
                                            <label class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('delete cardrequests')) echo "checked" @endphp
                                            ...
                                            <label class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                @php if($roles->hasPermissionTo('charge cardrequests')) echo "checked" @endphp
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                    @php if($roles->hasPermissionTo('view permissions')) echo "checked" @endphp
                                                    value="view permissions" name="permissions[]" />
                                                <span class="form-check-label">View</span>
                                            </label>
                                            <!--end::Checkbox-->
                                            <!--begin::Checkbox-->
                                            <label
                                                class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                    @php if($roles->hasPermissionTo('add permissions')) echo "checked" @endphp
                                                    value="add permissions" name="permissions[]" />
                                                <span class="form-check-label">Add</span>
                                            </label>
                                            <!--end::Checkbox-->
                                            <!--begin::Checkbox-->
                                            <label class="form-check form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                    @php if($roles->hasPermissionTo('edit permissions')) echo "checked" @endphp
                                                    value="edit permissions" name="permissions[]" />
                                                <span class="form-check-label">Edit</span>
                                            </label>
                                            <!--end::Checkbox-->
                                            <!--begin::Checkbox-->
                                            <label class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                    @php if($roles->hasPermissionTo('delete permissions')) echo "checked" @endphp
                                                    value="delete permissions" name="permissions[]" />
                                                <span class="form-check-label">Delete</span>
                                            </label>
                                            <!--end::Checkbox-->
                                        </div>
