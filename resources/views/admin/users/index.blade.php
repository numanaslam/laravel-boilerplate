                                    ...
                                    <div class="row search form-group mb-0">
                                        <div class="col-md-4">
                                            <input type="text" id="s_id" name="s_id"
                                                placeholder="ID" class="form-control" title="">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" id="s_email" name="s_email"
                                                placeholder="Email" class="form-control" title="">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" id="s_name" name="s_name"
                                                placeholder="Name" class="form-control" title="">
                                        </div>
                                    </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            //     data.id + '" href="kt_modal_scrollable_' + data.id +
                            //     '" class="px-2"><i class="fa-solid fa-eye text-success"></i></a><a href="{{ url('/users/edit') }}/' +
                            //     data.id +
