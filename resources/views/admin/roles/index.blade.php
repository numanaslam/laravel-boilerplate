                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ url('roles/add') }}" class="btn btn-primary btn-flat btn-sm ">Add Role</a>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="table-responsive">
                                    @foreach ($roles as $note)
                                        <div class="modal fade" tabindex="-1"
                                            id="kt_modal_scrollable_{{ $note->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">View Role
                                                            Details</h5>
                                                        <!--begin::Close-->
        ...
        function del(id, e) {
            ...
            var ans = Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = '{{ url('roles/delete') }}/' + id;
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (canEdit == "yes") {
                                ret += '<a href="{{ url('roles/edit') }}/' + data.id +
