...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ url('orders/add') }}" class="btn btn-primary btn-flat btn-sm ">Add
                                Order</a>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <table id="example2"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="fw-bold text-gray-600" style="width: 25%">Customer
                                        </th>
                                        <th class="fw-bold text-gray-600" style="width: 10%">Service
                                        </th>
    ...
    <script>
        function del(id, e) {
            ...
            if (userConfirmed) {
                window.location = '{{ url('orders/delete') }}/' + id;
            }
            return false;
        }
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (canView == "yes") {
                                ret +=
                                    '<a href="{{ url('orders/details') }}/' + data.id +
                                    '" class="px-2"><i class="fas fa-eye text-success"></i></a>';
                            }
                            if (canEdit == "yes") {
                                ret += '<a href="{{ url('orders/edit') }}/' + data.id +
