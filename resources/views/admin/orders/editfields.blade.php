            ...
            <div class="row">
                ...
                <div class="col-md-12 fv-row fv-plugins-icon-container">
                    ...
                    <select class="form-control" name="payment_method" id="payment_method" required>
                        <option value="bank" {{ (old('payment_method', $orders->payment_method) == 'bank') ? 'selected' : '' }}>
                            Bank Transfer
                        </option>
                        <option value="ep" {{ (old('payment_method', $orders->payment_method) == 'ep') ? 'selected' : '' }}>
                            Easy Paisa
                        </option>
                        <option value="jc" {{ (old('payment_method', $orders->payment_method) == 'jc') ? 'selected' : '' }}>
                            Jazz Cash
                        </option>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-md-12 fv-row fv-plugins-icon-container">
                    ...
                    <input type="number" class="form-control" id="amount" name="amount" placeholder="Amount"
                        value="{{ $orders->amount ? $orders->amount : old('amount') }}" required>
                    <div class="fv-plugins-message-container invalid-feedback">
                ...
                <div class="col-md-12 fv-row fv-plugins-icon-container">
                    ...
                    <input type="file" class="form-control" name="image" id="image" placeholder="Attachment"
                        value="{{ $orders->image ? $orders->image : old('image') }}">
                    <div class="fv-plugins-message-container invalid-feedback">
                        @if ($errors->has('image'))
                            {{ $errors->first('image') }}
                        @endif
                ...
                <div class="col-md-12 fv-row fv-plugins-icon-container">
                    ...
                    <select class="form-control" name="status" id="status" required>
                        ...
                        <option value="approved" {{ (old('status', $orders->status) == 'approved') ? 'selected' : '' }}>
                           Approved
                        </option>
                        <option value="rejected" {{ (old('status', $orders->status) == 'rejected') ? 'selected' : '' }}>
                            Rejected
                        </option>
                    </select>
