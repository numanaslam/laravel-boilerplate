                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ url('categories/add') }}" class="btn btn-primary btn-flat btn-sm ">Add
                                Category</a>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <table id="example2"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="fw-bold text-gray-600" style="width: 45%">Details
                                        </th>
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (canEdit == "yes") {
                                ret += '<a href="{{ url('categories/edit') }}/' + data.id +
